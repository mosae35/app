...
<?php 
                    ...
                    $all= ceil(count($data)/4);?>

<div class="">
   
    <div class="col-xs-12 col-lg-12 col-lg-offset-0 related_pro">
        <h3 class="text-center"> Related Products </h3><hr>
        <div class="carousel slide" id="myCarousel">
            <div class="carousel-inner">
                ...
                for($j=$i*4;$j<$perslide;$j++)
                {echo'
                        <li class="col-sm-3" style="text-align: center;">
                                ...
                                <div class="caption" style="border: 1px solid #DDD ;margin-top: -17px;">
                                    ...
                                    <p class="center-block price">'.$data[$k]['price'].' egp</p>
